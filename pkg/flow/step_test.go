...
func TestStepInterface(t *testing.T) {
	...
	steps := []Step{
		...
		&UploadFileStep{BaseStep: BaseStep{StepType: StepUploadFile}},
		&WaitForDownloadStep{BaseStep: BaseStep{StepType: StepWaitForDownload}},
		&GrantPermissionsStep{BaseStep: BaseStep{StepType: StepGrantPermissions}},
		&ResetPermissionsStep{BaseStep: BaseStep{StepType: StepResetPermissions}},
		&OpenTabStep{BaseStep: BaseStep{StepType: StepOpenTab}},
		&SwitchTabStep{BaseStep: BaseStep{StepType: StepSwitchTab}},
		&CloseTabStep{BaseStep: BaseStep{StepType: StepCloseTab}},
		&RunBrowserScriptStep{BaseStep: BaseStep{StepType: StepRunBrowserScript}},
		&GetConsoleLogsStep{BaseStep: BaseStep{StepType: StepGetConsoleLogs}},
		&ClearConsoleLogsStep{BaseStep: BaseStep{StepType: StepClearConsoleLogs}},
		&AssertNoJSErrorsStep{BaseStep: BaseStep{StepType: StepAssertNoJSErrors}},
		&MockNetworkStep{BaseStep: BaseStep{StepType: StepMockNetwork}},
		&BlockNetworkStep{BaseStep: BaseStep{StepType: StepBlockNetwork}},
		&SetNetworkConditionsStep{BaseStep: BaseStep{StepType: StepSetNetworkConditions}},
		&WaitForRequestStep{BaseStep: BaseStep{StepType: StepWaitForRequest}},
		&ClearNetworkMocksStep{BaseStep: BaseStep{StepType: StepClearNetworkMocks}},
...
func TestStepTypeConstants(t *testing.T) {
	...
	expectedTypes := map[StepType]string{
		...
		StepUploadFile:            "uploadFile",
		StepWaitForDownload:       "waitForDownload",
		StepGrantPermissions:      "grantPermissions",
		StepResetPermissions:      "resetPermissions",
		StepOpenTab:               "openTab",
		StepSwitchTab:             "switchTab",
		StepCloseTab:              "closeTab",
		StepRunBrowserScript:      "runBrowserScript",
		StepGetConsoleLogs:        "getConsoleLogs",
		StepClearConsoleLogs:      "clearConsoleLogs",
		StepAssertNoJSErrors:      "assertNoJSErrors",
		StepMockNetwork:           "mockNetwork",
		StepBlockNetwork:          "blockNetwork",
		StepSetNetworkConditions:  "setNetworkConditions",
		StepWaitForRequest:        "waitForRequest",
		StepClearNetworkMocks:     "clearNetworkMocks",
