...
LDFLAGS=-ldflags "-X github.com/phenchua29/maestro-runner/pkg/cli.Version=${VERSION} -X github.com/phenchua29/maestro-runner/pkg/cli.Commit=${COMMIT} -X github.com/phenchua29/maestro-runner/pkg/cli.BuildDate=${BUILD_DATE}"
